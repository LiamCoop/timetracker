...
INSERT INTO "DailyQuotes" ("id", "quote", "author", "category", "userId") VALUES
  ...
  ('dq16', 'Big energy only. Lets go.', NULL, 'energy', NULL),
  ('dq17', 'You didnt come this far to only come this far.', NULL, 'perseverance', NULL),
  ...
  ('dq24', 'Believe you can and youre halfway there.', 'Theodore Roosevelt', 'confidence', NULL),
